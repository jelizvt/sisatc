...
@ManagedBean
@ViewScoped
public class BuscarRequerimientoPersonaManaged extends BaseManaged {
	...
	public BuscarRequerimientoPersonaManaged() {
		...
		try {
			...
			if (comp != null) {
				...
				if (pantallaUso!=null&&pantallaUso.equals(ReusoFormCns.BUSQU_PER_INSPECCION)) {
						...
						ControlRequerimientoManaged controlReqManaged=(ControlRequerimientoManaged)getManaged("controlRequerimientoManaged");
						controlReqManaged.copiaPersona(bpd);
						//controlReqManaged.setSeleccionPersona(true);

						//controlReqManaged.setOcultarBoton(false);
						
				}else
					if(pantallaUso!=null&&pantallaUso.equals(ReusoFormCns.BUSQU_PER_INSPECCION_ACT)){
						ActualizarRequerimientoManaged actualizaReqManaged=(ActualizarRequerimientoManaged)getManaged("actualizarRequerimientoManaged");
						actualizaReqManaged.copiaPersona(bpd);
