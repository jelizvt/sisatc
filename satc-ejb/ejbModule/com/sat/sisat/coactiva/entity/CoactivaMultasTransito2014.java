 ...
 */
@Entity
@Table(name="COACTIVA_MULTAS_TRANSITO_2014")

@NamedQueries({
	@NamedQuery(name="getAllCoactivaMultasTransito2014", query="SELECT a FROM CoactivaMultasTransito2014 a ORDER BY a.id"),
	@NamedQuery(name="getCoactivaMultasTransito2014By", query="SELECT a FROM CoactivaMultasTransito2014 a WHERE a.campo4=:p_papeleta OR a.campo2=:p_nro_valor OR a.campo3=:p_placa ORDER BY a.id")
})

public class CoactivaMultasTransito2014 extends CobranzaCoactiva {
	@Id
	private Integer id;
