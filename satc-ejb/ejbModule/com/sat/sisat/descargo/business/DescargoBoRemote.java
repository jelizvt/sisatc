...
public interface DescargoBoRemote {
	...
	public abstract void descargarDeudas(CdDescargo cdDescargo, List<DeudaDTO> deudasAEliminar,Date fechaCompensacion, Integer persona_transferencia_id, String expedientesIds, String recibosIds, List<ReciboPagoDescargo> recibos,int modulo) throws SisatException;
