...
@Remote
public interface ValoresyResolucionesBoRemote {
	...
	public Integer actualizarSustento(Integer codigo, Integer condicionRequisito, String glosa,Integer flag,Integer id, Integer usuarioId,String terminal,Integer tipo) throws Exception;
