...
/**
 * The persistent class for the ra_djalcabala database table.
 * 
 */
@Entity
@Table(name = "ra_djalcabala")

public class RaDjalcabala implements Serializable {
	...
	// bi-directional many-to-one association to RaAlcabalaSustento
	// @OneToMany(mappedBy="raDjalcabala")
	// private List<RaAlcabalaSustento> raAlcabalaSustentos;
	...
	// bi-directional many-to-one association to RaTransferenteAlcabala
	// @OneToMany(mappedBy="raDjalcabala")
	//private List<RaTransferenteAlcabala> raTransferenteAlcabalas;

	// bi-directional many-to-one association to RaDireccionAlcabala
	// @OneToMany(mappedBy="raDjalcabala")
	// private List<RaDireccionAlcabala> raDireccionAlcabalas;
	...
	// public List<RaAlcabalaSustento> getRaAlcabalaSustentos() {
	// return this.raAlcabalaSustentos;
	// }
	//
	// public void setRaAlcabalaSustentos(List<RaAlcabalaSustento>
	// raAlcabalaSustentos) {
	// this.raAlcabalaSustentos = raAlcabalaSustentos;
	// }
	...
	// }
	//
	// public void setRaTipoTransferencia(RaTipoTransferencia
	// raTipoTransferencia) {
	// this.raTipoTransferencia = raTipoTransferencia;
	// }

	// public List<RaTransferenteAlcabala> getRaTransferenteAlcabalas() {
	// return this.raTransferenteAlcabalas;
	// }
	//
	// public void setRaTransferenteAlcabalas(List<RaTransferenteAlcabala>
	// raTransferenteAlcabalas) {
	// this.raTransferenteAlcabalas = raTransferenteAlcabalas;
	// }
	...
	// public List<RaDireccionAlcabala> getRaDireccionAlcabalas() {
	// return this.raDireccionAlcabalas;
	// }
	//
	// public void setRaDireccionAlcabalas(List<RaDireccionAlcabala>
	// raDireccionAlcabalas) {
	// this.raDireccionAlcabalas = raDireccionAlcabalas;
	// }
