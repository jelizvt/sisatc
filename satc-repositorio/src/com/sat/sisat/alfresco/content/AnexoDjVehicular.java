...
public class AnexoDjVehicular extends Contenido {

	private String tipoDocumento;
	private String nroDocumento;

	public AnexoDjVehicular() {
		super();
	}

	public AnexoDjVehicular(String name, byte[] contentBytes, String id) {
		super(name, contentBytes, id);
	}
		

	public AnexoDjVehicular(String name, byte[] contentBytes, String id, String tipoDocumento, String nroDocumento) {
		super(name, contentBytes, id);
	...
	public String getNombreRepositorio() {
		...
		return "/app:company_home/cm:SATCRepositorio/cm:Anexo/cm:AnexoDjVehicular";
	}

	public String getTipoContenido() {
		return Constantes.TYPE_ANEXO_DJ_VEHICULAR;
	}
