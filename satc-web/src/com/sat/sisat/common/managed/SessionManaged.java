...
public class SessionManaged extends BaseManaged {
	...
	public String fillPermisosModuloUsuario() {
		try {
			...
			try {
				...
				this.notario = permisoCaja.isNotario();
	...
	public int getLoteIdVehicular() {
		return loteIdVehicular;
	}

	public void setLoteIdVehicular(int loteIdVehicular) {
		this.loteIdVehicular = loteIdVehicular;
	}
	...
	public void setNotario(boolean notario) {
