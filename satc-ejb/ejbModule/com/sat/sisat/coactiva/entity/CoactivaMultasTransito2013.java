 ...
 */
@Entity
@Table(name="COACTIVA_MULTAS_TRANSITO_2013")

@NamedQueries({
	@NamedQuery(name="getAllCoactivaMultasTransito2013", query="SELECT a FROM CoactivaMultasTransito2013 a ORDER BY a.id"),
	@NamedQuery(name="getCoactivaMultasTransito2013By", query="SELECT a FROM CoactivaMultasTransito2013 a WHERE a.campo4=:p_papeleta OR a.campo2=:p_nro_valor OR a.campo3=:p_placa ORDER BY a.id")
})

public class CoactivaMultasTransito2013 extends CobranzaCoactiva {
	@Id
	private Integer id;
	
	private Integer campo1;
	private String campo2;//nro valor
	private String campo3;//placa
	private String campo4;//papeleta
