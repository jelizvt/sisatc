 ...
 */
@Entity
@Table(name="COACTIVA_IMPUESTO_VEHICULA_2012")

@NamedQueries({
	@NamedQuery(name="getAllCoactivaImpuestoVehicula2012", query="SELECT a FROM CoactivaImpuestoVehicula2012 a ORDER BY a.id"),
	@NamedQuery(name="getCoactivaImpuestoVehicula2012By", query="SELECT a FROM CoactivaImpuestoVehicula2012 a WHERE a.campo7=:p_persona_id OR a.campo3=:p_nro_valor ORDER BY a.id")
})
public class CoactivaImpuestoVehicula2012 extends CobranzaCoactiva {
	@Id
	private Integer id;
