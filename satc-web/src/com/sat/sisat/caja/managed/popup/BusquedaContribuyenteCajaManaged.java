...
//	}
	...
	public void ver() {
		try {			
			...
			if(cajaTupaManaged.getIsConstancia()) {
				cajaTupaManaged.setLstECRes(personaBo.getEstadoCuentaResumido(currentItem.getPersonaId()));
				...
				registrarConstanciaNoAdeudo.setPersonaId(currentItem.getPersonaId());
				registrarConstanciaNoAdeudo.viewdetalle();
				
			}
			
			if(cajaTupaManaged.getIsRecord()) {
				cajaTupaManaged.getAniosHR();
			}
