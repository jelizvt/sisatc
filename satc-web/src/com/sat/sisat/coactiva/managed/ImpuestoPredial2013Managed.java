...
import com.sat.sisat.coactiva.entity.CoactivaImpuestoPredial2013;
...
@ManagedBean
@ViewScoped
public class ImpuestoPredial2013Managed extends BaseManaged {
	@EJB
	...
	public void buscar(){
		try{
			...
			if((personaId!=null&&personaId>0)||(nroValor!=null&&nroValor.trim().length()>0)){
				lista=controlycobranzaBo.getAllImpuestoPredial2013(personaId,nroValor);
			}
		}catch(Exception e){
			e.printStackTrace();
	...
	public void exportHtmlTableToExcel() throws IOException{       
		try{
			List<CobranzaCoactiva> listaAll=controlycobranzaBo.getAllImpuestoPredial2013(); 
			  ...
			  htmlBuffer.append("<tr>");
				...
				htmlBuffer.append("<td>USO_PREDIO</td>");
				htmlBuffer.append("<td>CODIGO_PREDIO</td>");
				htmlBuffer.append("<td>CONTRIBUYENTE</td>");
				htmlBuffer.append("<td>VIA</td>");
				...
				htmlBuffer.append("<td>DEUDA_TOTAL</td>");
				htmlBuffer.append("<td>NRO_DOC</td>");
				htmlBuffer.append("<td>FECHA_EMISION_REC1</td>");
				htmlBuffer.append("<td>REC_UNO_FECHA_NOTIFICADA</td>");
				htmlBuffer.append("<td>CONDICION_UBI_INUB</td>");
				htmlBuffer.append("<td>FECHA_NOTIFICACION_REC_ACUMULACION</td>");
				htmlBuffer.append("<td>FECHA_EMISION_MEDIDA_CAUTELAR</td>");
				htmlBuffer.append("<td>MEDIDA_CAUTELAR_TIPO</td>");
				htmlBuffer.append("<td>FECHA_VARIACION_MEDIDA_CAUTELAR</td>");
				htmlBuffer.append("<td>TIPO_MEDIDA</td>");
				htmlBuffer.append("<td>FECHA_EMISION_OTRAS_RESOLUCIONES_ACTOS</td>");
				htmlBuffer.append("<td>TIPO_MEDIDA_ACTO</td>");
				...
				htmlBuffer.append("<td>FECHA_ACTO</td>");
				htmlBuffer.append("<td>COSTAS</td>");
				htmlBuffer.append("<td>OBSERVACIONES</td>");
				htmlBuffer.append("<td>INFORMACION_TERCEROS_FECHA_EMIS_REC</td>");
...
//				htmlBuffer.append("<td>MONTO_CANCELADO (MAY-NOV 2013)</td>");
			...
			htmlBuffer.append("</tr>");	
				...
				while (it2.hasNext()) {
					CoactivaImpuestoPredial2013 obj = (CoactivaImpuestoPredial2013)it2.next();
					htmlBuffer.append("<tr>");
...
//						htmlBuffer.append("<td>").append(obj.getMonto_pago()==null?"":obj.getMonto_pago()).append("</td>");
		      ...
		      String filename = "impuesto_predial_2013_"+System.currentTimeMillis() + ".xls";
		      //Setup the output
