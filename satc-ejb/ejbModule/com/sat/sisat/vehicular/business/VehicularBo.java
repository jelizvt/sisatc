...
//	}
	...
	@Override
	public List<CarteraVehiculosDTO> getCarteraVehiculos(int lote_id, int sector_id, int persona_id, String nro_req,
			int distrito_id, String placa) throws Exception {
		return vehicularDao.getCarteraVehiculos(lote_id,sector_id,persona_id,nro_req,distrito_id, placa);
	}
	...
	public List<DistritoDTO> getDistritos() throws Exception {
		...
		return vehicularDao.getDistritos();
	}
	...
	public int getNuevaCarteraVehiculos(List<CabCarteraVehicularDTO> lstTemporal, int usuario_id ,String terminal) throws Exception {
		// TODO Auto-generated method stub
		Integer lote_id = vehicularDao.ObtenerCorrelativoTabla("cc_lote", 1);
		
		
		return vehicularDao.getNuevaCarteraVehiculos(lote_id, lstTemporal, usuario_id , terminal);
	}
	...
	public void actualizarVehiculoOmiso(int marcaVehiculoId,int categoriaVehiculoId,int modeloVehiculoId
		...
		vehicularDao.actualizarVehiculoOmiso(marcaVehiculoId,categoriaVehiculoId,modeloVehiculoId,claseVehiculoId,carroceriaId,tipoMotorId
				,numeroCilindros, vehiculoId, usuarioId, terminal, fechaUpd);
		
	}
	
	@Override
	public List<CarteraVehiculosDTO> getCarteraVehiculosEditarMasivo(int lote_id,  String marca, String modelo) throws Exception {
		return vehicularDao.getCarteraVehiculosEditarMasivo(lote_id,marca,modelo);
	}
