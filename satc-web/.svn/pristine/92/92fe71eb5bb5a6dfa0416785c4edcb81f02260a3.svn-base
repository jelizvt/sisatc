...
@ManagedBean
@ViewScoped
public class ReporteEstadoPapeletasManaged extends BaseManaged {
	...
	public void generarReportesPartidasXLS() {
		...
		try {
			...
			JasperPrint jasperPrint = JasperFillManager.fillReport((SATWEBParameterFactory.getPathReporte()+"pa_reporte_estado_papeletas.jasper"),parameters,connection);
