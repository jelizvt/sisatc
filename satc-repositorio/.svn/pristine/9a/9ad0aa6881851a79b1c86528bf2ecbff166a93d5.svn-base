...
public class AnexoPapeleta extends Contenido {

	private String tipoDocumento;
	private String nroDocumento;

	public AnexoPapeleta(String name, byte[] contentBytes, String id) {
		super(name, contentBytes, id);
	}

		

	public AnexoPapeleta(String name, byte[] contentBytes, String id, String tipoDocumento, String nroDocumento) {
		super(name, contentBytes, id);
	...
	public String getNombreRepositorio() {
		...
		return "/app:company_home/cm:SATCRepositorio/cm:Anexo/cm:AnexoPapeleta";
	}

	public String getTipoContenido() {
		return Constantes.TYPE_ANEXO_PAPELETA;
	}
