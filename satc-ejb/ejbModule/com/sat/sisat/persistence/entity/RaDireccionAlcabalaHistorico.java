...
/**
 * The persistent class for the ra_direccion_alcabala_historico database table.
 * 
 */
@Entity
@Table(name="ra_direccion_alcabala_historico")
public class RaDireccionAlcabalaHistorico implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="direccion_alcabala_historico_id")
	private int direccionAlcabalaHistoricoId;
    ...
    public RaDireccionAlcabalaHistorico() {
    }

	public int getDireccionAlcabalaHistoricoId() {
		return this.direccionAlcabalaHistoricoId;
	}

	public void setDireccionAlcabalaHistoricoId(int direccionAlcabalaHistoricoId) {
		this.direccionAlcabalaHistoricoId = direccionAlcabalaHistoricoId;
	}
