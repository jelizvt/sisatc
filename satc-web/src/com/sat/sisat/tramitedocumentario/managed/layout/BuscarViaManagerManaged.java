...
@ManagedBean
@ViewScoped
public class BuscarViaManagerManaged extends BaseManaged {
	/**
	 * 
	 */
	...
	public BuscarViaManagerManaged() {
	...
	public void seleccionarEnMpDireccion() {
		try {
			 ...
			 */
			via = (ViaManaged) getManaged(beanName);

			via.setSelectedVia(currentItem);			
