...
@Local
public interface ObligacionBoLocal {
...
//	public void desactivarDetencion(Integer personaId, Integer conceptoId, Integer subConceptoId, Integer anho, Integer determinacionId)throws SisatException;
//	
//	public void activarDetencion(Integer personaId, Integer conceptoId, Integer subConceptoId, Integer anho, Integer determinacionId) throws SisatException;
	
	public void activarDetencionPapeleta(String nroPapeleta) throws SisatException;
	
	public void desactivarDetencionPapeleta(String nroPapeleta) throws SisatException;
	
	public Integer obtenerDiasHabiles(Date fechaAdquision, Date time) throws SisatException;
	
	public void notificarResolucionMulta(String nroActo) throws SisatException;
