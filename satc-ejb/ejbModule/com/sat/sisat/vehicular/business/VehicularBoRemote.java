...
@Remote
public interface VehicularBoRemote {
	/**
	...
	/**
	 * Obtiene una dj vehicular del transferente
	 * 
	 * @param personaId
	 *            Identificador único
	 * @return
	...
	public abstract List<HistoricoVehiculodjDTO> findHistoricoVehiculoDj(int personaId, String placa)
...
//	public abstract int guardarOperacionAuditoria (GnAuditoriaOperacion auditoria)throws Exception;
	...
	public abstract DatosNecesariosDeclaracionDTO obtenerReqDj(int djVehicularId);
