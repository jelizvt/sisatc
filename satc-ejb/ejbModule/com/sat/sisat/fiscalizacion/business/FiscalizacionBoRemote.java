...
@Remote
public interface FiscalizacionBoRemote {
	...
	public abstract int guardarRequerimiento (Integer tipoDocumento,String nroCorrelativo, Integer tipoPrograma,Integer nombreInspector, Date fechaInspeccion,
											  Integer codPersona,String observacion, String dirPersona,Date fechaNotifica,String anioInspeccion,
											  String tipoDocumentoRef,String nroDocumentoRef,Integer omiso,Integer estado)
										      throws Exception;
	
	public abstract int guardarRequerimientoDetalle (Integer inspectorId, String anio,Integer djId,Integer predioId,Integer inspcc_id,Date fechaInspeccion
													,Integer ubicacion,Integer sector,Integer tipoVia, Integer via,String manzana,String cuadra,String lado,String predioDir) 
													throws Exception;
	
	//public abstract int guardarRequerimientoDetalle (Integer anio,Integer djId,Integer predioId) throws Exception;
	...
	//public abstract List<FindInspeccionDj> getDeclaracionesInspById(Integer inspId,Integer personaId) throws Exception;
...
//	public abstract void editarInspector(MpFiscalizador f) throws Exception;
	...
	public int decargarOmniso(int omisoId,String justificacion) throws Exception;
	public List<Integer> estadisticaLote(int loteId) throws Exception;
	...
	public abstract int actualizarUbicacion(int reqId,int paquete,int annioPaquete,int expediente) throws Exception;
