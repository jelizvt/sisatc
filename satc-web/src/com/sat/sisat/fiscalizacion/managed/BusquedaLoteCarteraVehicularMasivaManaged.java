...
@ManagedBean
@ViewScoped
public class BusquedaLoteCarteraVehicularMasivaManaged extends BaseManaged {
	...
	public BusquedaLoteCarteraVehicularMasivaManaged() throws Exception {
	}
	...
	public void init() throws Exception {
		...
		try {			
			...
			lstFindLoteVehicular = ficalizacionBo.getAllLotesVehicular();			
	...
	public void generacionReqCarteraVehicular() {
		try {
				...
				try {
					...
					parameters.put("p_lote_id", getNroLoteasociado());
					parameters.put("p_sector_id", 0);
					parameters.put("p_nro_requerimiento", null);
					parameters.put("p_distrito_id", 0);
					parameters.put("p_placa", null);
					parameters.put("persona_id", 0);
	...
	public void estadistica(){
			...
			//
			try {
				listEstadisticas= ficalizacionBo.estadisticaLoteMasivo(findCcLoteItem.getLoteId());
				System.out.println(listEstadisticas.get(0));
