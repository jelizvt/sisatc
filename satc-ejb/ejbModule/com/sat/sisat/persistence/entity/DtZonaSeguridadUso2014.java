 ...
 */
@Entity
@Table(name="dt_zona_seguridad_uso_2014")
@NamedQueries(
	{
		@NamedQuery(name="getAllDtZonaSeguridadUso2014ByPeriodo", query="SELECT m FROM DtZonaSeguridadUso2014 m WHERE m.estado='1' AND m.zonaSeguridadId=:p_zona_seguridad_id AND m.periodo=:p_periodo "),
		@NamedQuery(name="getAllDtZonaSeguridadUso2014All", query="SELECT m FROM DtZonaSeguridadUso2014 m WHERE m.estado='1' AND m.periodo=:p_periodo "),
	}
)
public class DtZonaSeguridadUso2014 implements Serializable {
