 ...
 */
@Entity
@Table(name="dt_zona_seguridad_uso_2015")
@NamedQueries(
	{
		@NamedQuery(name="getAllDtZonaSeguridadUso2015ByPeriodo", query="SELECT m FROM DtZonaSeguridadUso2015 m WHERE m.estado='1' AND m.zonaSeguridadId=:p_zona_seguridad_id AND m.periodo=:p_periodo "),
		@NamedQuery(name="getAllDtZonaSeguridadUso2015All", query="SELECT m FROM DtZonaSeguridadUso2015 m WHERE m.estado='1' AND m.periodo=:p_periodo "),
	}
)
public class DtZonaSeguridadUso2015 implements Serializable {
