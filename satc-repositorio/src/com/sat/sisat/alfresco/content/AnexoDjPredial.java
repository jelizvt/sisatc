...
public class AnexoDjPredial extends Contenido {

	private String tipoDocumento;
	private String nroDocumento;

	public AnexoDjPredial() {
		super();
	}

	public AnexoDjPredial(String name, byte[] contentBytes, String id) {
		super(name, contentBytes, id);
	}

	
	public AnexoDjPredial(String name, byte[] contentBytes, String id, String tipoDocumento, String nroDocumento) {
		super(name, contentBytes, id);
	...
	public String getNombreRepositorio() {
		...
		return "/app:company_home/cm:SATCRepositorio/cm:Anexo/cm:AnexoDjPredial";
	}

	public String getTipoContenido() {
		return Constantes.TYPE_ANEXO_DJ_PREDIAL;
	}
