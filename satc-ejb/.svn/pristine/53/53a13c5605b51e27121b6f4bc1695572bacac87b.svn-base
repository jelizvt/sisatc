...
@Remote
public interface AdministracionBoRemote {
	 ...
	 * 
	 * @param tablaDTO
	 *            Contiene la informacion relacionada con la tabla maestra
	 * @return
	 * @throws SisatException
	 */
	 ...
	 * 
	 * @param tablaDTO
	 *            Contiene la informacion relacionada a la tabla maestra
	 * @return
	 * @throws SisatException
	 */
	 ...
	 * 
	 * @param lstParamsSelect
	 *            Contiene las columnas que pueden ser mostradas de la tabla
	 * @param tablaDTO
	 *            Contiene la informacion de la tabla maestra
	 * @return
	 * @throws SisatException
	 */
	...
	/**
	 * Método que obtiene el listado de campos editables de un registro de una
	 * tabla maestra
	 * 
	 * @param tablaDTO
	 *            Contiene los datos de la tabla maestra
	 * @return
	 * @throws SisatException
	 */
	 ...
	 * 
	 * @param lstFieldsEditables
	 *            Lista de campos editables de la tabla
	 * @throws SisatException
	 */
	 ...
	 * @param tablaDTO
	 *            Contiene la informacion sobre la tabla a la que pertenece el
	 *            registro
	 * @param rowLstDataDTO
	 *            Contiene el registro actual seleccionado
	 * @throws SisatException
	 */
	...
	/**
	 * Método para realizar el proceso de duplicacion de registros en una tabla
	 * maestra
	 * 
	 * @param lstKeyRows
	 *            Contiene el listado de id de los registros a duplicarse
	 * @param tablaDTO
	 *            Contiene la informacion de la tabla maestra
	 * @param lstFieldEditablesTable
	 *            Contiene informacion sobre los campos que pueden ser
	 *            duplicados
	 * @throws SisatException
	 */
	...
	/**
	 * Método para la obtención de datos de las claves foráneas para una tabla
	 * (FK)
	 * 
	 * @param campoDTO
	 *            Contiene la información del campo es es FK
	 * @return
	 * @throws SisatException
	 */
