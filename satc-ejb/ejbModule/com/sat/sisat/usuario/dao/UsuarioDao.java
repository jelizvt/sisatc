...
public class UsuarioDao extends GeneralDao{
	...
	public CajaPermisosDTO getPermisosCaja(int userId) throws SisatException {
		CajaPermisosDTO permiso = new CajaPermisosDTO();
		try {
			String SQL = new String("dbo.sg_get_permiso_caja ?");
			...
			while (rs.next()) {	
				CajaPermisosDTO obj = new CajaPermisosDTO();
				
				obj.setCajero(rs.getBoolean("iscajero"));
				obj.setSupervisorCaja(rs.getBoolean("issupervisorcaja"));
				obj.setNotario(rs.getBoolean("isnotario"));
