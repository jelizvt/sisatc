...
public class CjGenerico implements Serializable {
	...
	private String ListaVencimientos;
	...
	public String getListaVencimientos() {
		return ListaVencimientos;
	}

	public void setListaVencimientos(String listaVencimientos) {
